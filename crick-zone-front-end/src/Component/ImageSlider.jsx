...
const ImageSlider = (props) => {
    ...
    const img = [
        { url: "/src/assets/images/Boxes/3.jpg" },
        { url: "/src/assets/images/Boxes/4.jpg" },
        { url: "/src/assets/images/Boxes/5.webp" },
        { url: "/src/assets/images/Boxes/7.jpeg" },
        { url: "/src/assets/images/Boxes/8.jpg" },
    ];
